...
module.exports = {
  ...
  //     const planSets = Array.isArray(data.planSets) ? data.planSets : JSON.parse(data.planSets || "[]");
  ...
  //       const planFiles = req.files.filter(f => f.fieldname === `planSets[${index}][planFiles]`);
