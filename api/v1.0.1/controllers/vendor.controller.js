...
module.exports = {
  ...
  async addVendors(req, res) {
    try {
      ...
      const { user_id, name, email, phone, bill_to, ship_to, vendor_code, dba_name, tax_id, is_1099_eligible, payment_terms_id, incoterm_code, freight_terms, default_shipping_method_id, status,vendor_address,state,city } = req.body;
