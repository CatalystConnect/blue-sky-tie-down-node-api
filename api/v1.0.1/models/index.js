...
db.poLineObj.hasMany(db.purchaseOrderItemObj, {
...
db.itemLinksObj.belongsTo(db.itemObj, {
  foreignKey: 'linked_item_id',
  as: 'linkedItem',
});

db.itemObj.hasMany(db.itemLinksObj, {
  foreignKey: 'item_id',
  as: 'itemLinks',
});
...
db.purchaseOrderObj.hasMany(db.purchaseOrderReceiptLineObj, {
  foreignKey: "po_id",
  as: "receiptLines",
});

db.purchaseOrderObj.hasMany(db.purchaseOrderItemObj, {
  foreignKey: "poId",
...
db.purchaseOrderObj.belongsTo(db.wareHouseObj, {
  foreignKey: "shipToId",
  as: "warehouseDetails",
});
