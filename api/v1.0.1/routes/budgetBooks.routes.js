...
router.get("/get-budget-segment", [authJwt.verifyToken], budgetBooksController.getBudgetBySegment);

router.get("/getBudgetHistoryDetailById", [authJwt.verifyToken], budgetBooksController.getBudgetHistoryDetailById);
