...
/*projectTypes*/
router.post("/projectTypes/addProjectTypes",[authJwt.verifyToken],  projectTypesController.addProjectTypes);
...
router.put("/projectTypes/updateProjectTypes", [authJwt.verifyToken], projectTypesController.updateProjectTypes);
